...
#output_directory = r"D:\Publications\Bhaleka_1\data\era5_cloud_cover\processed_nwt_clipped_annual_mean"
output_directory = r"D:\Publications\Bhaleka_1\data\era5_cloud_cover\processed_nwt_clipped_cw_modis_annual_mean"
...
for file_path in raster_files:
    year = os.path.basename(file_path).split('_')[3].split('-')[0]
...
for year, files in tqdm(rasters_by_year.items(), desc="Processing years"):
    ...
    output_file_path = os.path.join(output_directory, f"era5_cloud_cover_{year}.tif")
