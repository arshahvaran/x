...
#input_dir = r"D:\Publications\Bhaleka_1\data\era5_cloud_cover\processed_nwt_clipped_annual_mean"
input_dir = r"D:\Publications\Bhaleka_1\data\era5_cloud_cover\processed_nwt_clipped_cw_modis_annual_mean"

#output_dir = r"D:\Publications\Bhaleka_1\data\era5_cloud_cover\processed_nwt_clipped_annual_mean_mk_test"
output_dir = r"D:\Publications\Bhaleka_1\data\era5_cloud_cover\processed_nwt_clipped_cw_modis_annual_mean_mk_test"
...
for year in tqdm(years, desc="Reading data"):
    file_path = os.path.join(input_dir, f"era5_cloud_cover_{year}.tif")
